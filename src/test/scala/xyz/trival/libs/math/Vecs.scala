...
import xyz.trival.libs.assertions.*

class Vec2Tests extends FunSuite:

  test("have unary constructor") {
    Vec2(2) ==> Vec2(2, 2)
    assertEquals(Vec2(2), Vec2(2, 2))
  }
...
class Vec3Tests extends FunSuite:
...
class Vec4Tests extends FunSuite:
